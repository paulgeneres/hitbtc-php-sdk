...
//        throw new InvalidRequestException($response->getBody());
    ...
    public function getActiveOrder($clientOrderId, $wait=NULL)
    {
    }
...
//        throw new InvalidRequestException($response->getBody());
    ...
    public function getTradingCommission($symbol)
    {
    }

    public function getOrdersHistory($symbol)
    {
    }

    public function getTradesHistory($symbol)
    {
    }
